...
const ClassesCalendar = () => {
  ...
  const convertAulasToEvents = (): EventInput[] => {
    const events = filteredAulas.map(aula => {
      ...
      // Adicionar ícones para tipos de aula especiais
      let iconeAula = '';
      ...
      const tituloCompleto = `${isSelectedItem && isSelectionMode ? '✓ ' : ''}${iconeAula}${nomeTurmaProcessado}`;
              ...
              .fc-event-title,
               ...
               /* Estilos específicos por idioma */
                ...
                .fc-event.idioma-particular {
                  background: linear-gradient(145deg, #8B5CF6 0%, #7C3AED 60%, #6D28D9 100%) !important;
