...
import { Search, Filter, Calendar, CreditCard, CheckCircle, XCircle, Clock, AlertTriangle, Trash2 } from 'lucide-react';
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50 hover:bg-gray-50">
                      ...
                      <TableHead className="font-bold text-gray-700">Aluno</TableHead>
                      <TableHead className="font-bold text-gray-700">Plano</TableHead>
                      <TableHead className="font-bold text-gray-700">Tipo</TableHead>
                      <TableHead className="font-bold text-gray-700">Idioma</TableHead>
                      <TableHead className="font-bold text-gray-700">Parcela</TableHead>
