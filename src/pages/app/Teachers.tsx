...
const Teachers = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    const success = await deleteTeacher(teacherToDelete);
    if (success) {
                ...
                <TableBody>
                  {teachers.map((teacher) => (
                    <TableRow key={teacher.id}>
                      <TableCell className="font-medium text-base">{teacher.nome}</TableCell>
                      <TableCell className="text-base">{teacher.cpf ? formatCPF(teacher.cpf) : 'Não informado'}</TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {teacher.salario ? (
                          ...
                          <span className="text-gray-400 text-base">Não informado</span>
                        )}
                      </TableCell>
                      <TableCell>
                        {teacher.senha ? (
